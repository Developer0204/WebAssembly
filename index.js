...
var ASM_CONSTS = {
 ...
 134360: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 134443: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 134512: () => { return window.innerWidth; },  
 134542: () => { return window.innerHeight; }
};
